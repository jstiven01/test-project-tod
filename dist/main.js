...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/storage */ \"./src/js/storage.js\");\n\nconsole.log('Hey 2020');\nvar project1 = {\n  name: 'My test Project',\n  tasks: [{\n    name: 'task number 1',\n    description: 'this is desc number 1'\n  }, {\n    name: 'task number 2',\n    description: 'this is desc number 2'\n  }, {\n    name: 'task number 3',\n    description: 'this is desc number 3'\n  }]\n};\nvar project2 = {\n  name: 'My test Project 2',\n  tasks: [{\n    name: 'task number 1',\n    description: 'this is desc number 1'\n  }, {\n    name: 'task number 2',\n    description: 'this is desc number 2'\n  }, {\n    name: 'task number 3',\n    description: 'this is desc number 3'\n  }]\n};\nvar project3 = {\n  name: 'My test Project 3',\n  tasks: [{\n    name: 'task number 1',\n    description: 'this is desc number 1'\n  }, {\n    name: 'task number 2',\n    description: 'this is desc number 2'\n  }, {\n    name: 'task number 3',\n    description: 'this is desc number 3'\n  }]\n}; //console.log(project);\n//localStorage.setItem('my name', JSON.stringify(project));\n\nconsole.log(_js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].create(project1.name, project1.tasks)); //true\n\nconsole.log(_js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].create(project1.name, project1.tasks)); // false\n//console.log(storage.read(project1.name)); // data array tasks\n\nvar data = _js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].read(project1.name); // store in data\n// console.log(data); //check data\n\ndata[0].name = 'task number 1 UPDATED';\nconsole.log(_js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].update(project1.name, data)); //update localstorage\n\nconsole.log(_js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].read(project1.name)); // check new update data\n\nconsole.log(_js_storage__WEBPACK_IMPORTED_MODULE_0__[\"default\"].remove(project1.name));\n/*\nconsole.log('updated',data); //update data\n*/\n\n//# sourceURL=webpack:///./src/index.js?");
